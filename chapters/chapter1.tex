...
Let $f(x)=1+\frac{1}{x}$, and $x_0$ be an arbitrary
 positive real number. Let $x_n=f(x_{n-1})$.
...
Now assume that $x_n$ converges to $a$ as $n$ approaches infinity.
 ...
 $a=\frac{1+\sqrt{5}}{2}$. To prove $x_n$ converges to $a$ indeed,
 we have:

\begin{align*}
|x_{n+1}-a| &= \left|x_{n+1}-\frac{1+\sqrt{5}}{2}\right| \\
&= \left|\frac{1-\sqrt{5}}{2}+\frac{1}{x_n}\right| \\
&= \left|\frac{2}{(1+\sqrt{5})x_n}\right|\cdot\left|x_n - \frac{1+\sqrt{5}}{2}\right| \\
&< \frac{2}{1+\sqrt{5}}\cdot|x_n - a| \\
&< \left(\frac{2}{1+\sqrt{5}}\right)^2\cdot|x_{n-1} - a| \\
&\cdots \\
&< \left(\frac{2}{1+\sqrt{5}}\right)^n\cdot|x_1 - a|
\end{align*}

Given that $0<|x_{n+1}-a|<\left(\frac{2}{1+\sqrt{5}}\right)^n\cdot|x_1 - a|$ and $\lim_{n\to\infty}\left(\frac{2}{1+\sqrt{5}}\right)^n\cdot|x_1 - a|=0$, by using squeeze rule we have $\lim_{n\to\infty}|x_{n+1}-a|=0$, i.e., $\lim_{n\to\infty}x_n=a=\frac{1+\sqrt{5}}{2}$.
