...
Sometimes, however, the functionalities we desire \text{depends on} uniqueness of every entry in the result, and redundancy would \text{break} their effectiveness. Consider the case where we're computing the average salary of all employees. If someone whose salary is higher than the actual average salary appears for multiple times in the result, the result would be higher than the actual average salary. In such circumstances, duplicate removal becomes necessary.
