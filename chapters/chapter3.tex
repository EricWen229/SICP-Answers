...
\lstinline{(stream-limit ln2-stream-transformed 1e-4)} can be evaluated in an instant. Compared to \lstinline{ln2-stream} where accuracy of just 3 decimal places takes noticable time, this is very impressive.
