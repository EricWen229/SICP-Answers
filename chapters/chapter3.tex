...
&= \max \{ \text{and-gate-delay} + \text{inverter-delay}, \text{or-gate-delay} \} * 2 + \text{and-gate-delay} * 2 \\
\text{delay}_{COUT} &= \text{delay}_{S} + \text{delay}_{C} + \text{or-gate-delay} \\
&= \max \{ \text{and-gate-delay} + \text{inverter-delay}, \text{or-gate-delay} \} + \text{and-gate-delay} * 2 + \text{or-gate-delay}
\end{align*}
