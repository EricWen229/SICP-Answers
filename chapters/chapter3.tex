...
It's really hard to tell the complexity, but by plotting we can actually tell that $a_n$ grows exponetially. To really prove the complexity, we may need to choose some other method, such as mathematical induction.

TODO: mathematical induction
