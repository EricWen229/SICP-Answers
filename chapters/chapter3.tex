...
When we look back, it appears that what we're looking for is just local state. This can be a perfect example illustrating that how obscure it can get to simulate local state without assignment, and one should use assignment when it's the most direct and intuitive option.
